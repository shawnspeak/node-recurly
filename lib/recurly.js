(function () {
    ...
    module.exports = function (config) {
        ...
        config.RECURLY_BASE_URL = 'https://' + config.RECURLY_HOST + '/v2';
        ...
        this.coupons = {
            lookup: function (couponCode, callback) {
                t.request('/coupons/' + couponCode, 'GET', callback);
            },
        ...
        this.subscriptions = {
            ...
            get: function (uuid, callback) {
                t.request('/subscriptions/' + uuid, 'GET', callback);
            },
            ...
            create: function (details, callback) {
                t.request('/subscriptions', 'POST', callback, t.js2xml(details, 'subscription'));
            },

            createForAccount: function (accountcode, details, callback) {
        ...
        this.subscriptionPlans = {
            listAll: function (callback) {
                t.request('/plans', 'GET', callback);
            },
            get: function (plancode, callback) {
                t.request('/plans/' + plancode, 'GET', callback);
            }
